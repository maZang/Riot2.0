...
def main():
	...
	init_centroid_mtrx = np.empty(shape=[len(initial_centroids), Consts.BLACK_MARKET_FEATURES - 2])
	row_index = 0
...
def _preprocess(mtrx):
	...
	mtrx = mtrx[:, 1:Consts.BLACK_MARKET_FEATURES-1]
